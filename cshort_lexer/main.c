...
const char *tokenToStr(TokenType type)
{
    ...
    case TOKEN_MENORQUE:
        return "MENOR QUE";
    case TOKEN_MAIORouIGUAL:
        return "MAIOR OU IGUAL";
    case TOKEN_MENORouIGUAL:
    ...
    case TOKEN_ABRECHAVE:
        return "ABRE CHAVE";
    case TOKEN_FECHACHAVE:
        return "FECHA CHAVE";
    case TOKEN_PONTOVIRGULA:
...
int main(int argc, char *argv[]) {
    ...
    if (argc > 1 && strcmp(argv[1], "lex") == 0) {
        ...
        parseProgram();  // usa o parser por padrão
    }
